...
final class MB_Admin {
	...
	private static function tab_sub( array $s ): void {
		...
		echo '<tr><th>کد مرچنت زیبال</th><td><input type="text" class="regular-text" name="mb[zibal_merchant]" value="' . esc_attr( (string) $s['zibal_merchant'] ) . '"><p class="description">برای تست می‌توانید merchant آزمایشی زیبال را طبق مستندات وارد کنید.</p></td></tr>';
		echo '<tr><th>merchant_id زرین‌پال</th><td><input type="text" class="regular-text" name="mb[zp_merchant]" value="' . esc_attr( (string) $s['zp_merchant'] ) . '"><p class="description">فقط اگر درگاه زرین‌پال را انتخاب کرده‌اید.</p></td></tr>';
	...
	private static function tab_sms( array $s ): void {
		...
		echo '<tr><th>api_key</th><td><input type="text" class="regular-text" name="mb[sms_api_key]" value="' . esc_attr( (string) $s['sms_api_key'] ) . '"></td></tr>';
		echo '<tr><th>نام کاربری (ملی‌پیامک)</th><td><input type="text" class="regular-text" name="mb[sms_username]" value="' . esc_attr( (string) $s['sms_username'] ) . '"></td></tr>';
