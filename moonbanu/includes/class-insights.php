...
final class MB_Insights {
	...
	public static function pms_window( int $user_id ): array {
		...
		// باید با همان پیش‌فرضی مقایسه شود که personal_pms_start() می‌سازد، وگرنه
		// پروفایل معمول ۲۸/۱۴ همیشه «شخصی‌سازی‌شده» علامت می‌خورد.
		$default = max( 2, (int) MB_Cycle_Engine::cycle_len( $user_id ) - 7 + 1 );
